...
jQuery(function($)
{
    ...
    var sseo_shortcode_start = '[eyesonly';
	...
	var sseo_shortcode_end = ']' + selected_content + '[/eyesonly]';
	...
	shortcode = shortcode + sseo_shortcode_end;
		...
		jQuery('#sseomodal_level_type option, #sseomodal-level option, #sseomodal-username option, #sseomodal-logged option, #sseomodal-hide option, #sseo_external_param option, #shortcode_rs_group option, #shortcode_pp_group option').prop('selected',false);
        tb_remove();
    }
});		